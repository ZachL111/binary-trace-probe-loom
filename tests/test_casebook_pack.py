"""Regression checks for the binary-trace-probe-loom casebook."""
...
from casebook.harness import assert_expected, binary_trace_probe_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(binary_trace_probe_loom_summary(), assert_expected())
