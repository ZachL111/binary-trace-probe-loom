...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-binary-trace-probe-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-binary-trace-probe-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-binary-trace-probe-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-binary_trace_probe_loom-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
